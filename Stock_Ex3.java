...
public class Stock  {
   ...
   final double MAX_COMM = 500.00;
   final double CALC_RATE = 0.01;
	...
	*/
    ...
    public double buyStock(){
      ...
      return calcValue() + calcCommision();    
    }
    ...
    public double calcValue(){
        ...
        double amount = price * getShares();
        return amount;
    }  
   public double calcCommision(){
      double commission = calcValue() * CALC_RATE;
